...
batch_size = 1000
dataloader_train = torch.utils.data.DataLoader(H5Dataset(num_chunk=499, h5_path='train_2.hdf5'),
                                               shuffle=True, batch_size=batch_size)
dataloader_test = torch.utils.data.DataLoader(H5Dataset(num_chunk=100, h5_path='test_2.hdf5'),
